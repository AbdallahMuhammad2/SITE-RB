...
import { ArrowRight, Star, ChevronRight, Check, Sparkles, Award, GraduationCap } from 'lucide-react';
          ...
          >
            ...
            <div className="relative z-10 p-12 md:p-16">
              ...
              >
                {/* Primary CTA */}
                <motion.button
                  className="relative group overflow-hidden px-10 py-5 rounded-xl"
              ...
              >
                <div className="flex -space-x-2">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-[#151318] overflow-hidden">
                      <img 
                        src={`https://source.unsplash.com/100x100/?portrait&sig=${i}`} 
                        alt="Student" 
                ...
                <div className="text-sm text-white/70">
                  <span className="text-white font-medium">4.9/5</span> de <span className="text-[#D4AF37] font-medium">8,500+</span> alunos
                </div>
              </motion.div>
            </div>
